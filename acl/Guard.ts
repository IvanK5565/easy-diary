import Acl from "./Acl";
import { AclRole, IRoles, IRules, GRANT } from "./types";

class Guard {
	private mAcl: Acl;
	private mRules?: IRules;
	private mRoles?: IRoles;
	private mRole?: AclRole;
 ...
 */
	...
	public allow(
		...
		try {
			...
			console.error('allow error', (e as Error).message)
			isAllowed = false;
		}
		// console.log("allow: ", this.role, resource, grant, ':',isAllowed);
