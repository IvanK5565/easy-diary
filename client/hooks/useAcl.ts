import { GRANT, IIdentity, AclRole } from "@/acl/types";
...
interface IUseAclResult {
  allow: (grant: GRANT, res?: string, role?: AclRole) => boolean;
...
export function useAcl() {
  ...
  try {
    ...
    res.allow = (grant: GRANT, res?: string, role?: AclRole) => {
...
//   const res:IUseAclResult = {
//     allow: (grant: GRANT, res?: string, role?: AclRole) => {
//       const r = res ? res : resource;
//       return guard.allow(grant, r, null, role);
//     },
