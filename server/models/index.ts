...
export function associateModels(container: AwilixContainer<IServerContainer>) {
  ...
  Subjects.hasMany(Schedule, {
    foreignKey: "subjectId",
    as: "scheduleBySubject",
  });
  Schedule.belongsTo(Subjects, {
    foreignKey: "subjectId",
    as: "subjectInSchedule",
  });
  ...
  Schedule.hasMany(Homeworks, {
    foreignKey: "scheduleId",
    as: "homeworksBySchedule",
  });
  Homeworks.belongsTo(Schedule, {
    foreignKey: "scheduleId",
    as: "scheduleByHomework",
  });

  // one to many - teacher has homeworks
  Users.hasMany(Homeworks, {
    foreignKey: "teacherId",
    as: "homeworksByTeacher",
  });
  Homeworks.belongsTo(Users, {
    foreignKey: "teacherId",
    as: "teacherByHomework",
  });
}
